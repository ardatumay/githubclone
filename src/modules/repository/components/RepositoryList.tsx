...
import { BasicList, globalStorageActions, Queries, useGlobalStorage } from "../../common"
...
export const RepositoryList: React.FunctionComponent<IRepositoryListProps> = (props) => {
    ...
    React.useEffect(() => {
        if (!!props.searchTerm) {
            ...
            setCustomReqVariables({ query, after: null })
        }
    }, [props.searchTerm])
    ...
    return (
        <BasicList
            ...
            customNoDataText={!!props.searchTerm ? "No repository found. Try different search text :)" : "No repository to show here. Search something.. "}
